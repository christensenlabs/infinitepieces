...
export default function LibraryCard({ title, desc, howToTell, do: doText, dont, color }) {
  return (
    <div className="bg-brand-panel/60 backdrop-blur-md rounded-3xl border border-white/5 shadow-xl overflow-hidden flex flex-col transition-transform hover:-translate-y-1 hover:shadow-2xl">
