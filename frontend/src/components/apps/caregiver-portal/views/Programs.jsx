...
export default function Programs() {
  return (
    <div className="space-y-6 animate-in fade-in duration-500 h-full flex flex-col pb-10">
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center bg-brand-panel/60 backdrop-blur-md border border-white/5 rounded-[2rem] p-12 shadow-lg">
