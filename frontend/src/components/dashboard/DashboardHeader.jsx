  ...
  return (
    <header className="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-8 shrink-0 z-10 shadow-sm">
      <div className="flex items-center gap-4">
        <h2 className="text-2xl font-black text-[#0B132B]">Infinite Suite OS</h2>
      ...
      <div className="flex items-center gap-6">
        <button
          ...
          className="hidden md:flex items-center gap-2 bg-gradient-to-r from-[#0B132B] to-blue-900 text-white px-5 py-2.5 rounded-full text-xs font-bold shadow-md hover:shadow-lg hover:scale-105 transition-all"
        >
        ...
        <div className="flex items-center gap-2 border-l border-slate-200 pl-6 cursor-pointer">
          ...
          />
          <span className="text-sm font-bold text-[#0B132B] hidden sm:block">
            {user?.name ?? 'Loading...'}
          </span>
